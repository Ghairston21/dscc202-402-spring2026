...
# MAGIC ON target.tpep_pickup_datetime = source.tpep_pickup_datetime AND
# MAGIC       target.tpep_dropoff_datetime = source.tpep_dropoff_datetime AND
# MAGIC       target.pickup_zip = source.pickup_zip
# MAGIC WHEN MATCHED THEN
# MAGIC     UPDATE SET fare_amount = source.fare_amount
# MAGIC WHEN NOT MATCHED THEN
# MAGIC     INSERT (tpep_pickup_datetime, tpep_dropoff_datetime, trip_distance, fare_amount, pickup_zip, dropoff_zip) VALUES (source.tpep_pickup_datetime, source.tpep_dropoff_datetime, source.trip_distance, source.fare_amount, source.pickup_zip, source.dropoff_zip);
